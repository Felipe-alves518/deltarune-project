...
function App() {
  ...
  return (
   ...
   <div className='bg-[#000000] relative overflow-hidden bg-no-repeat bg-center h-[780px] w-screen  flex flex-col items-center justify-center '>
      <img src='../public/assets/key-art.gif ' className='z-10 h-[780px] max-h-[780px] max-w-[960px]'/>

      {/* CHILD Div da logo */}
      <div className= "absolute z-20">
        <img src='../public/assets/logo.png' className='w-[600px] highlight-white'/>
    ...
    <div className='bg-[#004FDE] flex flex-col items-center'> {/*Div azul escuro */}
      ...
      <div className='flex flex-row flex-wrap  w-[500px] justify-center'>
        <Box image = "../public/assets/platform-square-steam-tall.png" bgcolor="gray"/>
        <Box image="../public/assets/platform-square-switch2.png" bgcolor="red" />
        <Box image="../public/assets/platform-square-ps5.png" bgcolor="white" invert = {true}  />
        <Box image="../public/assets/platform-square-switch.png" bgcolor="red" />
        <Box image="../public/assets/platform-square-ps4.png" bgcolor="blue" />
      ...
      <div className='grid grid-rows-2 grid-flow-col w-[550px] gap-[10px] my-[20px] '>
        <ImgBox img="../public/assets/ss-1-en.png"/>
        <ImgBox img="../public/assets/ss-4-en.png"/>
        <ImgBox img="../public/assets/ss-2-en.png"/>
        <ImgBox img="../public/assets/ss-5-en.png"/>
        <ImgBox img="../public/assets/ss-3-en.png"/>
        <ImgBox img="../public/assets/ss-6-en.png"/>
      </div>
    ...
    <div className=' flex flex-col bg-[#000000] items-center h-fit'> {/*Div final */}
      ...
      <div className='flex flex-col relative items-center h-[300px] w-[500px] justify-center my-[70px] '>
        <div className='absolute'>
          <img src="../public/assets/bg.gif" className=''/>
          <img src="../public/assets/ribbon.png" className='absolute left-[50%] top-[80%] translate-x-[-50%] '/>
            <div className=' absolute flex  left-[50%] top-[89%] translate-x-[-50%] h-[8%]'>
              ...
              <input type='image' className='border-2 mx-2 rounded-md border-white' src='../public/assets/platform-switch.png'/>
              <input type='image' className='border-2 mx-2 rounded-md border-white'  src='../public/assets/platform-ps4.png'/>
            </div>
        </div>

      <div className='absolute top-[50%]'>
        <img src="../public/assets/logo.png" className='w-[300px]'/>
      </div>  
    ...
    <p className='font-pixelify text-[#FFFFFF] text-lg '>NOTÍCIAS E ATUALIZAÇÕES</p>
      <div className='bg-[#00004d] w-[400px] h-fit rounded-md m-[20px] flex flex-col justify-items items-center p-[20px] font-pixelify text-[#FFFFFF]'>
        ...
        <div className='flex'>
        <Media image="../public/assets/social-bluesky.svg" />
        <Media image="../public/assets/social-twitter.svg"/>
        </div>
      ...
      <div>
          ...
          <News image="../public/assets/thumb-archive.png" date="Dec 25, 2022 -" title="Arquivo da caixa de correios"/>
          <News image="../public/assets/spamton-sweepstakes-logo.png" date="Dec 17, 2022 -" title="$pamton G. $pamton EVENTO ESPECIAL"/>
          <News image="../public/assets/thumb-green-room-door.png" date="Sept, 2022 -" title="Deltarune atualização de status"/>
          <News image="../public/assets/thumb-ch2-thanks.png" date="Sept, 2021 -" title="Deltarune atualização de status"/>
          <News image="../public/assets/thumb-ch2.png" date="Sept, 2020 -" title="Deltarune atualização de status"/>
          </div>
      </div>
